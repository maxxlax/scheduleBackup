...
import modList.MyEmployeeModList;

@SuppressWarnings("serial")
public class ViewEmployeesPanel extends JPanel
{

	public MyEmployeeModList myEmployeeList;
  ...
  public MainPanel mainPanel;
	...
	public ViewEmployeesPanel(MainPanel mainPanel)
	{
		...
		myEmployeeList = new MyEmployeeModList(mainPanel);
  ...
  public void setModListAsObserver(EmployeeList employeeList)
  {
    employeeList.addObserver(myEmployeeList);
  }
