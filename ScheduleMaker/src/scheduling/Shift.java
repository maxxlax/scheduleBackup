...
public class Shift implements Comparable<Shift>
{
	...
	public int compareTo(Shift shift)
	{
		...
		{
			if(type.equals(ShiftType.Driver)) return 1;
			else return -1;
		}
		else if(startTime == shift.startTime)
		{
			if(endTime > shift.endTime) return -1;
			else if(endTime < shift.endTime) return 1;
			else return 0;
		}
		else if(startTime < shift.startTime) return -1;
		else if(startTime > shift.startTime) return 1;
		else return -1;
	}
